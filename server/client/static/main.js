...
/* harmony import */ var _ventana_moderador_ventana_moderador_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./ventana-moderador/ventana-moderador.component */ "./src/app/ventana-moderador/ventana-moderador.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _ventana_moderador_ventana_moderador_component__WEBPACK_IMPORTED_MODULE_31__["VentanaModeradorComponent"]
            ],
            imports: [
...
/* harmony import */ var _ventana_moderador_ventana_moderador_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ventana-moderador/ventana-moderador.component */ "./src/app/ventana-moderador/ventana-moderador.component.ts");
/* harmony import */ var _home_home_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./home/home.component */ "./src/app/home/home.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _tabla_de_decision_tabla_de_decision_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tabla-de-decision/tabla-de-decision.component */ "./src/app/tabla-de-decision/tabla-de-decision.component.ts");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./login/login.component */ "./src/app/login/login.component.ts");
/* harmony import */ var _register_register_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./register/register.component */ "./src/app/register/register.component.ts");
/* harmony import */ var _jugar_jugar_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./jugar/jugar.component */ "./src/app/jugar/jugar.component.ts");
/* harmony import */ var _moderador_moderador_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./moderador/moderador.component */ "./src/app/moderador/moderador.component.ts");
/* harmony import */ var _fin_juego_fin_juego_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./fin-juego/fin-juego.component */ "./src/app/fin-juego/fin-juego.component.ts");
...
var APPROUTES = [
    ...
    { path: 'tabla', component: _tabla_de_decision_tabla_de_decision_component__WEBPACK_IMPORTED_MODULE_3__["TablaDeDecisionComponent"] },
    { path: 'tabla/:nombreEmpresa', component: _tabla_de_decision_tabla_de_decision_component__WEBPACK_IMPORTED_MODULE_3__["TablaDeDecisionComponent"] },
    { path: 'tabla/:nombreEmpresa/:codigo', component: _tabla_de_decision_tabla_de_decision_component__WEBPACK_IMPORTED_MODULE_3__["TablaDeDecisionComponent"] },
    { path: 'home', component: _home_home_component__WEBPACK_IMPORTED_MODULE_1__["HomeComponent"] },
    { path: 'jugar', component: _jugar_jugar_component__WEBPACK_IMPORTED_MODULE_6__["JugarComponent"] },
    { path: 'moderador', component: _moderador_moderador_component__WEBPACK_IMPORTED_MODULE_7__["ModeradorComponent"] },
    { path: 'ingresoPuntajes', component: _ventana_moderador_ventana_moderador_component__WEBPACK_IMPORTED_MODULE_0__["VentanaModeradorComponent"] },
    { path: 'fin', component: _fin_juego_fin_juego_component__WEBPACK_IMPORTED_MODULE_8__["FinJuegoComponent"] },
    { path: 'fin/:numeroBimestre', component: _fin_juego_fin_juego_component__WEBPACK_IMPORTED_MODULE_8__["FinJuegoComponent"] },
    { path: '**', pathMatch: 'full', redirectTo: 'home' }
];
// tslint:disable-next-line:eofline
var APP_ROUTER = _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forRoot(APPROUTES);
...
var JugarComponent = /** @class */ (function () {
    function JugarComponent(router, formBuilder, http, toastr) {
        this.router = router;
        this.formBuilder = formBuilder;
        this.http = http;
        this.toastr = toastr;
    ...
    JugarComponent.prototype.onClickMe = function () {
        ...
        this.http.game.joinGame(body_send, function (response) {
            if (response.message && response.message == "ok") {
                ...
                _this.alertaBienvenidoEmpresa("Damos la bienvenida a tu empresa: " + _this.nombre_empresa);
                _this.router.navigate(['/tabla']);
            }
            else
                // alert(`Error: ${response}`)
                _this.alertaError("Error: " + ("" + response));
        });
    };
    JugarComponent.prototype.alertaBienvenidoEmpresa = function (name) {
        this.toastr.info(name);
    };
    JugarComponent.prototype.alertaError = function (mensaje) {
    ...
    JugarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], _services_http_service__WEBPACK_IMPORTED_MODULE_5__["HttpService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrService"]])
    ], JugarComponent);
...
var ModeradorComponent = /** @class */ (function () {
    function ModeradorComponent(http, formBuilder, router, toastr) {
        this.http = http;
        this.formBuilder = formBuilder;
        this.router = router;
        this.toastr = toastr;
        ...
        this.http.game.createGame(this.moderador, function (response) {
            if (response.message && response.message == "ok") {
                ...
                _this.http.game.joinGameModerator(codigo, function (response) {
                    if (response.message && response.message == "ok") {
                        _this.alertaBienvenidoModerador("Bienvenido al juego: " + _this.moderador.nombreMercado);
    ...
    ModeradorComponent.prototype.alertaBienvenidoModerador = function (mensaje) {
        this.toastr.info(mensaje);
    };
    ModeradorComponent.prototype.alertaError = function (mensaje) {
        this.toastr.error(mensaje);
    };
    ModeradorComponent.prototype.verPuntajes = function () {
    ...
    ModeradorComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_http_service__WEBPACK_IMPORTED_MODULE_3__["HttpService"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"]])
    ], ModeradorComponent);
...
var TablaDeDecisionComponent = /** @class */ (function () {
    function TablaDeDecisionComponent(http, route, router, toastr) {
        this.http = http;
        this.route = route;
        this.router = router;
        this.toastr = toastr;
        ...
        this.http.game.getVentasIndustria(this.numeroBimestre, function (response) {
            ...
            if (response != 'error con el socket') {
                ...
                if (_this.esFinCalculo == false) {
                    _this.alertaCalculosFinalizados();
    ...
    TablaDeDecisionComponent.prototype.alertaCalculosFinalizados = function () {
        this.toastr.success("Calculos finalizados para el bimestre " + this.numeroBimestre + ". Ya puede acceder a las demás pestañas.");
    };
    TablaDeDecisionComponent.prototype.alertaCalculosNoFinalizadosOFaltanJugadores = function (error) {
    ...
    TablaDeDecisionComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_http_service__WEBPACK_IMPORTED_MODULE_8__["HttpService"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"], ngx_toastr__WEBPACK_IMPORTED_MODULE_13__["ToastrService"]])
...
/***/ "./src/app/ventana-moderador/ventana-moderador.component.css":
/*!*******************************************************************!*\
  !*** ./src/app/ventana-moderador/ventana-moderador.component.css ***!
  \*******************************************************************/
/*! no static exports found */
...
/***/ "./src/app/ventana-moderador/ventana-moderador.component.html":
/*!********************************************************************!*\
  !*** ./src/app/ventana-moderador/ventana-moderador.component.html ***!
  \********************************************************************/
/*! no static exports found */
...
module.exports = "<form class=\"formularioModerador\" [formGroup]=\"registerForm\" #form=\"ngForm\">\n  <header>MODERADOR </header>\n  <br>\n  <br>\n  <div class=\"form-group\">\n    <label>Código del Juego</label>\n    <input type=\"text\" formControlName=\"codigo\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && f.nombreMercado.errors }\"\n      placeholder=\"Código de tu juego\" />\n    <div *ngIf=\"submitted && f.codigo.errors\" class=\"invalid-feedback\">\n      <div *ngIf=\"f.codigo.errors.required\" style=\"color: red\">Código del juego es requerido</div>\n    </div>\n  </div>\n  <br>\n\n  <button type=\"submit\" (click)=\"onClickMe()\">Hecho</button>\n\n</form>\n"

/***/ }),

/***/ "./src/app/ventana-moderador/ventana-moderador.component.ts":
/*!******************************************************************!*\
  !*** ./src/app/ventana-moderador/ventana-moderador.component.ts ***!
  \******************************************************************/
/*! exports provided: VentanaModeradorComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VentanaModeradorComponent", function() { return VentanaModeradorComponent; });
/* harmony import */ var _models_moderador__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../models/moderador */ "./src/models/moderador.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _services_http_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../../services/http.service */ "./src/services/http.service.ts");
...
var VentanaModeradorComponent = /** @class */ (function () {
    function VentanaModeradorComponent(http, formBuilder, router) {
        this.http = http;
        this.formBuilder = formBuilder;
        this.router = router;
        this.submitted = false;
    ...
    VentanaModeradorComponent.prototype.ngOnInit = function () {
        this.registerForm = this.formBuilder.group({
            codigo: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required],
        });
    };
    Object.defineProperty(VentanaModeradorComponent.prototype, "f", {
        get: function () { return this.registerForm.controls; },
        enumerable: true,
        configurable: true
    });
    VentanaModeradorComponent.prototype.onClickMe = function () {
        var _this = this;
        this.submitted = true;
        // stop here if form is invalid
        if (this.registerForm.invalid) {
        ...
        this.http.game.joinGameModerator(this.moderador.codigo, function (response) {
            if (response.message && response.message == "ok") {
                _this.router.navigate(['/fin']);
            }
        });
    };
    VentanaModeradorComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-ventana-moderador',
            template: __webpack_require__(/*! ./ventana-moderador.component.html */ "./src/app/ventana-moderador/ventana-moderador.component.html"),
            styles: [__webpack_require__(/*! ./ventana-moderador.component.css */ "./src/app/ventana-moderador/ventana-moderador.component.css")]
        }),
    ...
    return VentanaModeradorComponent;
}());
...
module.exports = __webpack_require__(/*! /Users/samuel/Documents/GitHub/SimulatorServer/angular/src/main.ts */"./src/main.ts");
